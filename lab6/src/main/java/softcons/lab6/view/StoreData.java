...
public class StoreData {
	...
	factory=new AnnotationConfiguration().addAnnotatedClass(City.class).
                buildSessionFactory();
        ...
        {
        System.out.println(result.get(i).getCity()+" "+result.get(i).getLatitude()+" "+result.get(i).getLongitude());
